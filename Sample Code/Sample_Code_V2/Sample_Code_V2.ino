 ...
 */
 Servo4.write(0); //Writes a value of 0 to the servo, meaning it attempts to rotate to 0 degrees
 delay(2000); //Waits for 2000 milliseconds, or 2 seconds

 Servo4.write(180); //Writes a value of 180 to the servo, meaning it attempts to rotate to 180 degrees
 delay(2000); //Waits for 2000 milliseconds, or 2 seconds
